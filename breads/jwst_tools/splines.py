...
def _task_fit_3dspline(paras):
    ...
    k0,k1,k2,k3,l0,l1,l2,l3 = stamp_ids
    ...
    def _tmp_fm(nonlin_paras, data_obj: "Instrument"):
        ...
        if reg_mean_map is not None and reg_std_map is not None:
            ...
            return _d, M, _e
    results = fitfm(nonlin_paras=[],dataobj=_tmp_obj,fm_func=_tmp_fm,fm_paras={},marginalize_noise_scaling=False, scale_noise=False)
    ...
    spline3d_paras_np[:,l1:l2+1,k1:k2+1] = paras_canvas[:,(l1-l0):(l2-l0+1),(k1-k0):(k2-k0+1)]
    spline3d_paras_err_np[:,l1:l2+1,k1:k2+1] = paras_err_canvas[:,(l1-l0):(l2-l0+1),(k1-k0):(k2-k0+1)]
...
def fit_3dspline(dataobj,x_nodes,y_nodes,wv_nodes,
    ...
    spline3d_paras_mp = RawArray(mp_float_type, N_wv_nodes * N_y_nodes * N_x_nodes)
    spline3d_paras_shape = (N_wv_nodes, N_y_nodes, N_x_nodes )
    ...
    spline3d_paras_err_mp = RawArray(mp_float_type, N_wv_nodes * N_y_nodes * N_x_nodes)
...
def evaluate_3dspline(ifux,ifuy,wvs,
    ...
    spline3d_paras_shape = (N_wv_nodes, N_y_nodes, N_x_nodes )
    spline3d_paras_np = _arraytonumpy(spline3d_paras_mp, spline3d_paras_shape, dtype=mp_float_type)
    spline3d_paras_np[:] = spline3d_paras

    spline3d_paras_err_mp = RawArray(mp_float_type, N_wv_nodes * N_y_nodes * N_x_nodes)
    spline3d_paras_err_np = _arraytonumpy(spline3d_paras_err_mp, spline3d_paras_shape, dtype=mp_float_type)
    spline3d_paras_err_np[:] = spline3d_paras_err

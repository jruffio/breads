...
from .splines import get_spline_model
import subprocess

def get_breads_commit():
    """Get the current BREADS git commit hash."""
    try:
        import breads
        import os
        breads_dir = os.path.dirname(breads.__file__)
        ...
        print(f"Could not retrieve BREADS commit hash: {e}")
        return 'UNKNOWN'
